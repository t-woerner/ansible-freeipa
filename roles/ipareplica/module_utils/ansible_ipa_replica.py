...
__all__ = ["contextlib", "dnsexception", "dnsresolver", "dnsreversename",
           ...
           "adtrustinstance", "paths", "api", "ipautil", "dsinstance",
           "ipaldap", "Env", "IPA_PYTHON_VERSION", "installutils",
...
ANSIBLE_IPA_REPLICA_IMPORT_ERROR = None
try:
    ...
    ANSIBLE_IPA_REPLICA_IMPORT_ERROR = str(_err)
