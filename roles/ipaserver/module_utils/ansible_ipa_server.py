...
__all__ = ["IPAChangeConf", "certmonger", "sysrestore", "root_logger",
           ...
           "NUM_VERSION", "time_service", "adtrust_imported", "kra_imported",
           "dsinstance", "IPA_PYTHON_VERSION", "api", "paths", "ipautil"]
...
ANSIBLE_IPA_SERVER_IMPORT_ERROR = None
try:
    ...
    ANSIBLE_IPA_SERVER_IMPORT_ERROR = str(_err)

    for attr in __all__:
        setattr(sys.modules[__name__], attr, None)

    adtrust_imported = False
    adtrust_imported = False
